          ...
          <div class="wrap-li">
            ...
            <thead>
             <tr>
              ...
              <td width="180" ><s:property value="#vo.id"/></td>
              <td width="180"><s:property value="#vo.nick"/></td>
              <td width="180"><s:property value="#vo.phone"/></td>
           <td width="280"><s:property value="#vo.age"/></td>
               <td width="280"> 
              <s:if test="#vo.gender==1">男</s:if>
	           <s:else>女</s:else> </td>
              <td width="180"><s:property value="#vo.create_time"/></td>
              <td width="180"><s:property value="#vo.score"/></td>
              <td width="180"><s:property value="#vo.money"/></td>
              <td width="380"><a href="user_getUserById.action?id=<s:property value="#vo.id"/>">查看详细信息</a></td>
            </tr> 
              </s:iterator>
		...
		<tr>
			...
			<span>
			   <s:if test="currPage != 1">
					<a href="user_getUserList.action?currPage=1">[首页]</a>&nbsp;&nbsp;
                    <a href="user_getUserList.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
               </s:if> 
               <s:if test="currPage != totalPage">
					<a href="user_getUserList.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
                    <a href="user_getUserList.action?currPage=<s:property value="totalPage"/>">[尾页]<s:property value="totalPage"/></a>&nbsp;&nbsp;
               </s:if> 
            </span>
            </td>
		</tr>
